...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-teal-400 to-blue-500 p-4">
  <form
    method="POST"
  ...
  >
    ...
    <button class="btn btn-primary w-full py-3 relative overflow-hidden group" disabled={loading}>
      ...
      <span class="relative">{loading ? 'Registering...' : 'Register'}</span>
    </button>
  </div>
  <div class="mt-6 text-center">
    <p class="text-sm text-gray-600">Already have an account? 
      <a href="/login" class="text-teal-600 hover:text-teal-800 transition-colors font-medium">Log in</a>
    </p>
  </div>
  <div class="mt-8">
    <div class="relative">
